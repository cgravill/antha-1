// antha/printer/printer_test.go: Part of the Antha language
...
// Use antha test -update to create/update the respective golden files.
var data = []entry{
...
// can be printed (per antha/ast specification). Test case for issue 3870.
