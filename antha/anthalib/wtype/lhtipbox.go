...
// returns true if any new tips were added
func (tb *LHTipbox) Refill(idGen *id.IDGenerator) bool {
	initialTips := tb.N_clean_tips()
	initialize_tips(idGen, tb, tb.Tiptype)
	return tb.NRows()*tb.NCols() > initialTips
}
