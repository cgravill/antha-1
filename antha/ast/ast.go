// antha/ast/ast.go: Part of the Antha language
...
// match the corresponding Go/Antha spec production names to which they
...
// Useful for ASTs generated by code other than the Go/Antha parser.
//
func NewIdent(name string) *Ident { return &Ident{token.NoPos, name, nil} }

// IsExported reports whether name is an exported Go/Antha symbol
...
// IsExported reports whether id is an exported Go/Antha symbol
...
func (d *AnthaDecl) Pos() token.Pos { return d.TokPos }
...
func (d *AnthaDecl) End() token.Pos {
	...
	return d.TokPos + 1 // no BRACE should be an error condition
}
...
// collectively building a Go/Antha package.
//
type Package struct {
