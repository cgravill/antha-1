...
func (this *Liquidhandler) GetPlates(labEffects *effects.LaboratoryEffects, plates map[string]*wtype.Plate, major_layouts map[int][]string, ptype *wtype.Plate) (map[string]*wtype.Plate, error) {
	if plates == nil {
